...
def route_to_validator(state: PipelineState) -> str:
    ...
    route_map = {
        ...
        ContentType.NOTARY_PUBLIC.value: "validate_notary",
    }
...
def aggregate_results(state: PipelineState) -> PipelineState:
    ...
    validation_map = {
        ...
        ContentType.NOTARY_PUBLIC.value: state.get("notary_validation", {}),
    }
...
def build_pipeline() -> StateGraph:
    ...
    workflow.add_node("validate_notary", validate_notary)
    ...
    workflow.add_conditional_edges(
        ...
        route_to_validator,
        {
            ...
            "validate_notary": "validate_notary",
        },
    )
    ...
    for validator in ["validate_news", "validate_judge", "validate_official",
                      ...
                      "validate_template", "validate_notary"]:
