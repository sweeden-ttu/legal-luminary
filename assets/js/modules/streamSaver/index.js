export const streamSaver = ( (e, t) => t())(0, ( () => {
    "use strict";
        ...
        createWriteStream: function(r, m, c) {
            ...
            if (!o) {
                ...
                if (a) {
                    ...
                    w = new i.TransformStream(e,d.writableStrategy,d.readableStrategy);
                    const t = w.readable;
                    g.port1.postMessage({
                        readableStream: t
                    }, [t])
                ...
                g.port1.onmessage = e => {
                    ...
                    g.port1.postMessage("abort"),
                    g.port1.onmessage = null,
                    g.port1.close(),
                    g.port2.close(),
                    g = null)
                }
            ...
            let h = [];
            return !o && w && w.writable || new i.WritableStream({
                write(e) {
                    if (!(e instanceof Uint8Array))
                        throw new TypeError("Can only write Uint8Arrays");
                    o ? h.push(e) : (g.port1.postMessage(e),
                    p += e.length,
                    u && (location.href = u,
                    u = null))
                },
